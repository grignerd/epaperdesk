...
if(in_array  ('curl', get_loaded_extensions())) {
    if(in_array  ('zip', get_loaded_extensions())) {
        ...
        set_time_limit(0);
        $fp = fopen ($file, 'w+');
        $url = "https://github.com/grignerd/epaperdesk/raw/master/epaperdesk.zip";
        ...
        if($data=='1'){
            ...
            if ($res === TRUE) {
                ...
                ECHO '<br><a href="/" class="btn btn-primary font-weight-bold"><i class="fa fa-globe"></i> GO TO SETUP</a>';
            }else{
        ...
        echo "<h3 style='color: RED'><i class='fa fa-times-circle'></i> Sorry, Zip module is inactive on your web server.</h3>";
    }
}else{
    echo "<h3 style='color: RED'><i class='fa fa-times-circle'></i> Sorry, CURL module is inactive on your web server.</h3>";
}
?>
